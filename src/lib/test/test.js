...
describe("Test Vector 3 (SEP-0005)", () => {
    ...
    describe("Public Key (m/44'/148'/0')", () =>
        it("should return: GC3MM...BTPJQ", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic)).publicKey(),
    ...
    describe("Public Key (m/44'/148'/1')", () =>
        it("should return: GB3MT...YYISO", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 1).publicKey(),
    ...
    describe("Public Key (m/44'/148'/2')", () =>
        it("should return: GDYF7...DGAKU", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 2).publicKey(),
    ...
    describe("Public Key (m/44'/148'/3')", () =>
        it("should return: GAFLH...JUWBD", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 3).publicKey(),
    ...
    describe("Public Key (m/44'/148'/4')", () =>
        it("should return: GAXG3...GS3NN", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 4).publicKey(),
    ...
    describe("Public Key (m/44'/148'/5')", () =>
        it("should return: GA6RU...CGCFQ", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 5).publicKey(),
    ...
    describe("Public Key (m/44'/148'/6')", () =>
        it("should return: GCUDW...ZCVQS", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 6).publicKey(),
    ...
    describe("Public Key (m/44'/148'/7')", () =>
        it("should return: GBJ64...636G4", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 7).publicKey(),
    ...
    describe("Public Key (m/44'/148'/8')", () =>
        it("should return: GDHX4...YSRM4", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 8).publicKey(),
    ...
    describe("Public Key (m/44'/148'/9')", () =>
        it("should return: GDXOY...CKZX7", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 9).publicKey(),
    ...
    describe("Secret Key (m/44'/148'/0')", () =>
        it("should return: SAEWI...D5AX7", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic)).secret(),
    ...
    describe("Secret Key (m/44'/148'/1')", () =>
        it("should return: SBKSA...3FYB4", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 1).secret(),
    ...
    describe("Secret Key (m/44'/148'/2')", () =>
        it("should return: SD5CC...IHESQ", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 2).secret(),
    ...
    describe("Secret Key (m/44'/148'/3')", () =>
        it("should return: SBSGS...GZQPK", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 3).secret(),
    ...
    describe("Secret Key (m/44'/148'/4')", () =>
        it("should return: SBIZH...HGXWM", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 4).secret(),
    ...
    describe("Secret Key (m/44'/148'/5')", () =>
        it("should return: SCVM6...QQ6OY", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 5).secret(),
    ...
    describe("Secret Key (m/44'/148'/6')", () =>
        it("should return: SBSHU...2ZEO2", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 6).secret(),
    ...
    describe("Secret Key (m/44'/148'/7')", () =>
        it("should return: SC2QO...YWC6E", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 7).secret(),
    ...
    describe("Secret Key (m/44'/148'/8')", () =>
        it("should return: SCGMC...MAQST", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 8).secret(),
    ...
    describe("Secret Key (m/44'/148'/9')", () =>
        it("should return: SCPA5...C37GF", () =>
            assert.equal(
                redshift.genKeypair(redshift.mnemonicToSeedHex(testVector3Mnemonic), 9).secret(),
